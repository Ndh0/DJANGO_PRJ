...
urlpatterns = [	
    ...
    path('admin/',views.admin,name="adminspace"),
    path('adminperslist/',views.adminperslist,name="adminperslist"),
    path('admincltlist/',views.admincltlist,name="admincltlist"),
    path('adminprjlist/',views.adminprjlist,name="adminprjlist"),
    path('serviceadd/',views.ServiceAdd),
    path('projetadd/',views.ProjetAdd),
    path('personneladd/',views.PersonnelAdd,name='addpersonne'),
    path('equipeadd/',views.EquipeAdd),
    path('equipelist/',views.EquipeList),
    path('servicelist/',views.ServiceList),
    path('projetlist/',views.ProjetList,name='pjlist'),
    ...
    #path('clientlist/',views.ClientList),
    path('addclient/<int:id>/', views.ClientAdd, name='addclient'),
